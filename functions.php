<?php
/**
 * Kern — theme entry point (thin loader, nothing more).
 *
 ...
 * is inc/bootstrap.php (the namespace + the KERN_SLUG/KERN_VERSION constants).
 *
 * [CORE] This is the portable loader. The `kern` CLI rewrites the namespace
 * and slug on the way into each theme it generates, so a shipped theme's
 * functions.php is byte-for-byte this file with `Kern`/`kern` swapped
