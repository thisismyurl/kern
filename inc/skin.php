...
function kern_skin_pattern_categories(): void {
	register_block_pattern_category(
		KERN_SLUG . '-sections',
		array(
			'label'       => __( 'Kern: Sections', 'kern' ),
			'description' => __( 'Section patterns for building pages.', 'kern' ),
		)
	);
 ...
 */
add_filter( KERN_SLUG . '/preload_fonts', static function ( array $fonts ): array {
