 ...
 * the skin (Kern's personality). Each sheet depends on the previous so the
 ...
 * the kern/preload_fonts filter (registered in inc/skin.php).
 *
...
function enqueue_assets(): void {
	...
	$sheets = array(
		...
		'skin'  => 'assets/css/skin.css',       // [SKIN] Kern's layout, components, blocks, utilities.
	);
...
function preload_fonts(): void {
	 ...
	 */
	$fonts = (array) apply_filters( 'kern/preload_fonts', array() );
