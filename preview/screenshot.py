#!/usr/bin/env python3
"""
screenshot.py — Playwright screenshot capture for the Kern theme preview.
...
PAGES = [
    ...
    ("02-studio-bio.html",       1440, 900,  "02-studio-bio.png",             True),
    ("03-case-study.html",       1280, 900,  "03-case-study.png",             True),
    ("04-typeface-specimen.html",1200, 900,  "04-typeface-specimen.png",      True),
    ("05-brief.html",            1200, 900,  "05-brief-contact.png",          True),
    ...
    ("09-terracotta.html",       1200, 900,  "09-terracotta-variant.png",     True),
    ("10-midnight.html",         1200, 900,  "10-midnight-variant.png",       True),
]
...
async def main():
    print("Kern theme — screenshot capture")
