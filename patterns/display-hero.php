...
<section class="wp-block-group alignfull kern-display-hero has-studio-paper-background-color has-background" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16);padding-left:var(--wp--preset--spacing--6);padding-right:var(--wp--preset--spacing--6)">
	...
	<h1 class="wp-block-heading kern-display-hero__headline has-studio-black-color has-text-color has-fraunces-font-family has-display-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--7);font-style:normal;font-weight:300;letter-spacing:-0.03em;line-height:0.98"><?php esc_html_e( 'Type as thought.', 'kern' ); ?></h1>
	<!-- /wp:heading -->
	...
	<p class="kern-display-hero__descriptor has-studio-mid-color has-text-color has-jakarta-font-family has-md-font-size" style="margin-top:0;margin-bottom:0;font-weight:400;line-height:1.5"><?php esc_html_e( 'A typography studio shaping letterforms, identities, and the systems that hold them together.', 'kern' ); ?></p>
	<!-- /wp:paragraph -->
